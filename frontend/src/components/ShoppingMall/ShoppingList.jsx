...
const ShoppingList = () => {
    ...
    useEffect(() => {
        ...
        .then((res) => {
            ...
            axios.get(`https://j9a307.p.ssafy.io:5000/api/v1/marriage-stuffs/liked_items`, {params})
            .then((response) => {
    ...
    useEffect(() => {
        ...
        axios.get(`https://j9a307.p.ssafy.io:5000/api/v1/marriage-stuffs/catalogue`, {params})
        .then ((response) => {
