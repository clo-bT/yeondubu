...
const ShoppingList = () => {
    ...
    useEffect(() => {
        ...
        .then((res) => {
            ...
            axios.get(`${process.env.REACT_APP_FLASK_ROOT}:5000/api/v1/marriage-stuffs/liked_items`, {params})
            .then((response) => {
    ...
    useEffect(() => {
        ...
        axios.get(`${process.env.REACT_APP_FLASK_ROOT}:5000/api/v1/marriage-stuffs/catalogue`, {params})
        .then ((response) => {
